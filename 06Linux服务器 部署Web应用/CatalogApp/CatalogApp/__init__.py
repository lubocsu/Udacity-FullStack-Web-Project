...
CLIENT_ID = json.loads(
    open(r'/var/www/CatalogApp/CatalogApp/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(r'/var/www/CatalogApp/CatalogApp/client_secrets.json', scope='')
...
def fbconnect():
    ...
    app_id = json.loads(
        open(r'/var/www/CatalogApp/CatalogApp/fb_client_secrets.json', 'r').read())['web']['app_id']
    app_secret = json.loads(
        open(r'/var/www/CatalogApp/CatalogApp/fb_client_secrets.json', 'r').read())['web']['app_secret']
